...
//     let candidates = deamination::find_bases::extract_bcf_positions(PathBuf::from(format!(
//         "{}/candidates.bcf",
//         basedir
//     )))?;
...
//         candidates,
//         PathBuf::from(format!("{}/mutations.bcf", basedir)),
//     )
//     .with_context(|| "error filtering mutations")?;
//     assert_eq!(true_filtered_candidates, filtered_candidates);
//     Ok(())
// }
...
//         candidates,
//         PathBuf::from(format!("{}/inconsistent.bed", basedir)),
//     )
//     .with_context(|| "error filtering mutations")?;
//     assert_eq!(true_filtered_candidates, filtered_candidates);
//     Ok(())
...
// //     let basedir = basedir(test);
// //     let filtered_candidates = deamination::find_bases::extract_bcf_positions(
// //         PathBuf::from(format!("{}/candidates.bcf", basedir))
// //     )?;
// //     // Read true output file and get its content
// //     let true_output = format!("{}/candidates_out.bcf", basedir);
